...
// Release signing: reads android/key.properties (gitignored). Locally it points at
// D:/dev/keys/...; in CI the workflow writes it from repository secrets.
...
android {
    ...
    defaultConfig {
        ...
        // DND control (NotificationManager.setInterruptionFilter) needs API 23+;
        // Flutter's default is >= that, and the CI verifies it from the built APK.
